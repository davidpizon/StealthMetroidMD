...
//Level: Level_1 
{  1,1280,256, //id, x, y 
   1792,768,4,34, // w, h, start of entities, end of entities 
   {  -1  , -1  , -1  , -1  , -1  , -1  , -1  , -1 },
...
//Level: CityStreets 
{  2,3584,1792, //id, x, y 
   1536,512,35,34, // w, h, start of entities, end of entities 
   {  -1  , -1  , -1  , -1  , -1  , -1  , -1  , -1 },
     &CityStreets_tileset, &CityStreets_map, &bgb_tileset, &bgb_map, &CityStreets_colmap 
} 
 };
#define SIZEENTARRAY  35
const int ALLENTS[SIZEENTARRAY]={
BlankGuard, 152, 280, 1, PlayerStart, 308, 532, BlankGuard, 640, 344, 1, 
BlankGuard, 680, 528, 1, BlankGuard, 616, 144, 0, SimpleDoor, 464, 537, 
0, SimpleDoor, 1561, 392, 0, SimpleDoor, 779, 645, 0, SimpleDoor, 624, 
608, 0
};
