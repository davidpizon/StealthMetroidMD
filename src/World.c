...
//Level: Level_1 
{  1,1280,256, //id, x, y 
   1792,768,4,30, // w, h, start of entities, end of entities 
   {  -1  , -1  , -1  , -1  , -1  , -1  , -1  , -1 },
...
//Level: CityStreets 
{  2,3584,1792, //id, x, y 
   1536,512,31,30, // w, h, start of entities, end of entities 
   {  -1  , -1  , -1  , -1  , -1  , -1  , -1  , -1 },
     &CityStreets_tileset, &CityStreets_map, &bgb_tileset, &bgb_map, &CityStreets_colmap 
} 
 };
#define SIZEENTARRAY  31
const int ALLENTS[SIZEENTARRAY]={
BlankGuard, 152, 280, 1, PlayerStart, 308, 532, BlankGuard, 640, 344, 1, 
BlankGuard, 680, 528, 1, BlankGuard, 616, 144, 0, SimpleDoor, 385, 516, 
0, SimpleDoor, 338, 442, 0, SimpleDoor, 266, 410, 0
};
