...
//Level: Level_1 
{  1,1280,256, //id, x, y 
   1792,768,4,49, // w, h, start of entities, end of entities 
   {  -1  , -1  , -1  , -1  , -1  , -1  , -1  , -1 },
...
//Level: CityStreets 
{  2,3584,1792, //id, x, y 
   1536,512,50,49, // w, h, start of entities, end of entities 
   {  -1  , -1  , -1  , -1  , -1  , -1  , -1  , -1 },
...
ed_BlankGuard, 712, 528, 1, ed_BlankGuard, 616, 144, 0, ed_SimpleDoor, 464, 537, 
0, ed_SimpleDoor, 1561, 392, 0, ed_SimpleDoor, 779, 645, 0, ed_Camera, 612, 
511, 1, 1500, 60, 576, 544, ed_SpawnPoint, 573, 534, 2, ed_Stairway, 
676, 543, 672, 408, ed_Stairway, 675, 407, 680, 544
};
